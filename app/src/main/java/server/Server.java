...
public class Server   {
    ...
    private final int totalNbAcorns = 61;
    ...
    */
    public boolean clientSetTrap(String clientName, String imageName) {
        ...
        if(clientCounts.containsKey(clientName) && excludedMap.containsKey(imageName)) {
            // place the trap
    ...
    */
    public String clientRunInTrap(String clientName, String imageName) {
        ...
        return "You've walked into a trap of " + trapOwner +  "!\nYou loose " + nbAcornsToTransfer + " acorns..."
